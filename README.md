...
- 🧠 **Когнитивные тренажёры** (в духе Wikium/NeuroNation, но на коде): Таблица Шульте,
  Код N-назад, Найди баг, Ментальный интерпретатор — адаптивная сложность по «правилу 85%».
