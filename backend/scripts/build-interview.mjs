...
const DECKS = [
  { slug: 'blitz', id: '55555555-5555-5555-5555-555555550009', name: 'Блиц · Короткие факты', description: 'Короткие вопросы для разминки-блица (варианты + таймер) перед глубокими колодами' },
